...
#define MIN_TEMEPERATURE - 50   // Celsius
#define MAX_TEMPERATURE 50

#define MIN_HUMIDITY 0          // %
#define MAX_HUMIDITY 100

#define MIN_WIND_DIRECTION 0    // Degrees
#define MAX_WIND_DIRECTION 360

#define MIN_WIND_INTENSITY 0    // m/s
#define MAX_WIND_INTENSITY 100

#define MIN_RAIN_HEIGHT 0       // mm/h
...
//Random value to simulate evironmental station sensor
int get_next_value(int min, int max){
...
//Prepare data of all environmental staion's sensors in one buffer
int prepare_data(char* data){

    int temperature_value = get_next_value(MIN_TEMEPERATURE, MAX_TEMPERATURE);
    int humidity_value = get_next_value(MIN_HUMIDITY, MAX_HUMIDITY);
    int wind_direction_value = get_next_value(MIN_WIND_DIRECTION, MAX_WIND_DIRECTION);
    int wind_intensity_value = get_next_value(MIN_WIND_INTENSITY, MAX_WIND_INTENSITY);
    int rain_height_value = get_next_value(MIN_RAIN_HEIGHT, MAX_RAIN_HEIGHT);
...
static int cmd_publish_environmental_station_data(int argc, char** argv){
    ...
    //Initializations for environmental station data 
    srand(time(0));
    char data[128];
...
static const shell_command_t shell_commands[] = {
    ...
    { "pub_ES_data", "publish data related to an environmental station", cmd_publish_environmental_station_data },
    { NULL, NULL, NULL }
};
